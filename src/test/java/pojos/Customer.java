...
public class Customer {
    ...
    public Customer(Integer id, String firstName, String middleInitial, String email, String mobilePhoneNumber, String phoneNumber, String zipCode, String address, String city, String ssn, String createDate, Boolean zelleEnrolled, Country country, String state, User user, Account accounts) {
        this.id = id;
